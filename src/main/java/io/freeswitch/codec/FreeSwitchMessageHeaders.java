 ...
 */
public class FreeSwitchMessageHeaders {
    /**
     * Standard ESL header names.
     * <p>
     * Note this enum will need to be kept in synch with any new headers
     * introduced on the server side.
     */
    public enum HeaderName {
        /*
		 * Minor optimization - put most often used headers at the top for
		 * fastest resolution in static fromLiteral().
		 */
        ...
        private HeaderName(String literal) {
            this.literal = literal;
        }

        public static HeaderName fromLiteral(String literal) {
            for (HeaderName name : values()) {
    ...
    /**
     * Some common ESL header values. These are provided as a convenience for
     * commonly used values.
     * <p>
     * This values are not coded as an enum to allow for the very large range of
     * possible values, since they are just Strings.
     */
